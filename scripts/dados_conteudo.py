...
GLOSSARIO = [
 ...
 ("Beneficiário / Cidadão-usuário", _S, "Destinatário da saída do processo no setor público. Pode ser interno (outra unidade da Codevasf) ou externo — cidadão, irrigante, comunidade beneficiária, ente federativo ou órgão parceiro.", "SIPOC", "SIPOC"),
 ("Linha de Base (Indicador)", _I, "Valor de referência inicial de um indicador, usado como base para comparar resultados futuros.", "PMBOK", "Indicador; Meta"),
 ...
 ("Entrada", _S, "Insumo, informação, documento ou recurso necessário para iniciar ou executar uma atividade do processo.", "SIPOC", "SIPOC"),
 ...
 ("Fornecedor", _S, "Pessoa, área ou sistema que fornece insumos (entradas) ao processo.", "SIPOC", "SIPOC"),
 ...
 ("Linha de Base (Projeto)", _P, "Versão aprovada do escopo, prazo ou custo, usada como referência para comparação com o desempenho real.", "PMBOK", "Baseline; Escopo; Cronograma"),
 ...
 ("Marco", _P, "Ponto significativo no cronograma, normalmente a conclusão de uma entrega importante. Não consome tempo.", "PMBOK", "Cronograma; Entrega"),
 ...
 ("SIPOC", _S, "Ferramenta visual que descreve um processo em alto nível por meio de cinco elementos: Fornecedores, Entradas, Processo, Saídas e Beneficiários.", "Six Sigma / CBOK", "Fornecedor; Entrada; Saída"),
 ("Saída", _S, "Produto, serviço, informação ou decisão gerada pelo processo e entregue a um cliente.", "SIPOC", "SIPOC"),
